...
class SeasonPageDeterminator extends BaseClass
{
	#_patterns = [
		...
		/^https:\/\/burning-series\.io\/serie\/[0-9a-z\-]+\/?$/i,
		/^https:\/\/burning-series\.io\/serie\/[0-9a-z\-]+\/\d+\/?$/i,
		/^https:\/\/burning-series\.io\/serie\/[0-9a-z\-]+\/\d+\/[a-z]+\/?$/i,
		/^https:\/\/burning-series\.net\/serie\/[0-9a-z\-]+\/?$/i,
		/^https:\/\/burning-series\.net\/serie\/[0-9a-z\-]+\/\d+\/?$/i,
		/^https:\/\/burning-series\.net\/serie\/[0-9a-z\-]+\/\d+\/[a-z]+\/?$/i,
		...
		/^https:\/\/burningseries\.tw\/serie\/[0-9a-z\-]+\/?$/i,
		/^https:\/\/burningseries\.tw\/serie\/[0-9a-z\-]+\/\d+\/?$/i,
		/^https:\/\/burningseries\.tw\/serie\/[0-9a-z\-]+\/\d+\/[a-z]+\/?$/i,
