...
class SeasonPageDeterminator extends BaseClass
{
	#_patterns = [
		...
		/^https:\/\/burningseries\.io\/serie\/[0-9a-z\-]+\/?$/i,
		/^https:\/\/burningseries\.io\/serie\/[0-9a-z\-]+\/\d+\/?$/i,
		/^https:\/\/burningseries\.io\/serie\/[0-9a-z\-]+\/\d+\/[a-z]+\/?$/i,
		/^https:\/\/burningseries\.net\/serie\/[0-9a-z\-]+\/?$/i,
		/^https:\/\/burningseries\.net\/serie\/[0-9a-z\-]+\/\d+\/?$/i,
		/^https:\/\/burningseries\.net\/serie\/[0-9a-z\-]+\/\d+\/[a-z]+\/?$/i,
